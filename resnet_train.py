...
def main():
    ...
    metrics = model_config.get_confusion_matrix_metrics(class_id=class_id)
    ...
    # define callbacks
    from tensorflow.keras.callbacks import CSVLogger, LearningRateScheduler, TensorBoard, ModelCheckpoint, ReduceLROnPlateau, EarlyStopping
    # Prepare model model saving directory.
    ckpt_name = "%s-epoch-{epoch:03d}-auc-{auc:.4f}.h5" % model_type
    filepath = os.path.join(ckpt_dir, model_type)
